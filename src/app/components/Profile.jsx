    ...
    return (
        <>
            ...
            <div className="flex items-center mt-3 gap-3">
                ...
                <svg 
                width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="lucide lucide-twitter-icon lucide-twitter cursor-pointer">
